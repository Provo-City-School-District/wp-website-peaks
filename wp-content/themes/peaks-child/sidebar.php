<aside id="mainSidebar">
			<section class="calendar-agenda">
				...
				<a href="<?php echo get_home_url(); ?>/school-information/calendar/">Provo Peaks Elementary School Calendar (Month View)</a>
			</section>
			<section>
				...
				<ul class="imagelist">
					...
					<li>
						<a href="https://reportcard.schools.utah.gov/School/OverAllPerformance?SchoolID=180612&DistrictID=1222&SchoolNbr=103&SchoolLevel=K8&IsSplitSchool=0&schoolyearendyear=2023">
							<img src="https://globalassets.provo.edu/image/icons/policies-lt.svg" alt="" />
